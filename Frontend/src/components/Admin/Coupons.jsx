...
const Coupons = () => {
  ...
  return (
    <div className="h-[90vh] flex flex-col bg-white dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 rounded-lg shadow-md">
      ...
      {/* Header */}
      <div className="flex justify-between items-center px-4 md:px-6 py-4 border-b border-gray-200 dark:border-zinc-800">
        ...
        <Link
          ...
          className="flex items-center gap-2 px-4 py-2 bg-blue-500 hover:bg-blue-600 dark:bg-blue-500 dark:hover:bg-blue-600 text-white rounded-lg shadow text-sm md:text-base cursor-pointer"
        >
                ...
                currentCoupons.map((coupon) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-center">
                      <button
                        className="text-red-500 dark:text-red-400 hover:text-red-700 dark:hover:text-red-500 cursor-pointer"
      ...
      {coupons.length > couponsPerPage && (
        <div className="flex justify-center items-center gap-2 py-4 border-t border-gray-200 dark:border-zinc-800">
          <button
            className="px-3 py-1 bg-gray-200 dark:bg-zinc-700 hover:bg-gray-300 dark:hover:bg-zinc-600 text-gray-800 dark:text-gray-200 rounded cursor-pointer disabled:opacity-50"
      ...
      {confirmCoupon && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-lg p-6 w-80 shadow-lg">
            ...
            <div className="flex justify-end gap-3">
              <button
                className="px-4 py-2 rounded bg-gray-300 dark:bg-zinc-700 hover:bg-gray-400 dark:hover:bg-zinc-600 text-gray-800 dark:text-gray-200 cursor-pointer"
              ...
              <button
                className="px-4 py-2 rounded bg-red-500 hover:bg-red-600 dark:bg-red-500 dark:hover:bg-red-600 text-white cursor-pointer"
                onClick={() => {
