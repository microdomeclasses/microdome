  ...
  return (
    <div className="w-full h-screen flex items-center justify-center">
      ...
      <form
        ...
        className="w-[95%] max-w-sm p-6 bg-white dark:bg-zinc-950 border border-gray-200 dark:border-zinc-700 rounded-lg shadow-lg flex flex-col justify-center"
      >
        ...
        <input
          ...
          className="mb-3 border border-gray-300 dark:border-zinc-600 bg-white dark:bg-zinc-900 text-gray-800 dark:text-gray-100 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 px-2 py-1.5 rounded-md"
