...
function Contact() {
  ...
  return (
    <section
      id="contact"
      className="
      relative min-h-screen w-full py-20 px-0 text-gray-900
      dark:text-white
    "
    >
    ...
    bg-gray-50/10 dark:bg-gray-50/10
    border border-zinc-900/10 dark:border-gray-700/30
    rounded-2xl p-6 md:p-10 shadow-lg transition-all duration-300
  "
          >
         ...
         resize-none focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500"
              ...
              {status === "error" && (
                <div className="mt-4 p-4 bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 rounded-lg border border-red-200 dark:border-red-700">
                  Failed to send message. Try again later or email us directly.
                </div>
              )}
            </form>
          </div>
