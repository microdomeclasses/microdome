...
const Instructors = () => {
  ...
  return (
    <section className="w-full max-w-6xl mx-auto px-4 my-8 md:my-16">
      {/* Heading Section */}
      ...
      <h1
        ...
        data-aos-delay="150"
      >
        Our <span className="text-button text-highlighted">Instructors</span>
      </h1>
      <p className="text-center mt-4" data-aos="fade-up" data-aos-delay="300">
      ...
      {/* Navigation Buttons */}
      <div
        className="mt-6 mx-auto w-full md:w-[95%] flex items-center gap-5 justify-center md:justify-end text-white"
        data-aos="fade-up"
        data-aos-delay="100"
      >
        <button
