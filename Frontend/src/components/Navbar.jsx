...
const Navbar = () => {
  ...
  return (
    <nav
      className={`${theme} fixed top-4 left-1/2 -translate-x-1/2 w-[95%] max-w-6xl transition-all duration-300 ${
          ...
          <div className="flex flex-col gap-2 text-base">
            ...
            {!isLoggedIn && (
              <NavLink
                ...
                className="mt-2 px-4 py-2 bg-highlighted text-white rounded-lg text-center font-semibold"
              >
                Login
              </NavLink>
            )}
