...
const Developers = () => {
  ...
  return (
    <div className="min-h-screen py-24 px-6 transition-colors duration-500">
      <h1
      ...
      <div className="grid gap-8 md:grid-cols-3 max-w-5xl mx-auto mt-16 px-4">
        {founders.map((founder, index) => (
          <div
            key={index}
            className="bg-gray-100 dark:bg-zinc-900/80 border border-gray-200 dark:border-zinc-800 rounded-xl shadow-lg px-6 py-8 flex flex-col items-center hover:shadow-2xl transition duration-300"
            data-aos="zoom-in"
          >
            <img
              src={founder.img}
              alt={founder.name}
              className="w-32 h-32 object-cover rounded-full ring-2 ring-highlighted ring-offset-2 ring-offset-white dark:ring-offset-zinc-900 shadow-md"
            />
