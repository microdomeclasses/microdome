...
const SemesterCourseLayout = () => {
  ...
  return (
    <div className="w-full flex items-center justify-center">
       <ToastContainer />
      <div className="mt-8 w-full max-w-6xl mx-auto flex flex-col-reverse lg:flex-row justify-center lg:gap-10 lg:py-6 mb-16 px-4">
       
        <div className="w-full mx-auto lg:w-[60%] z-20 mt-16">
